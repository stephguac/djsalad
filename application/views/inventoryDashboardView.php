...
?>
    ...
    <div class="container">
        <div class="row">
            ...
            <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#addProductModal">
                    Add Product
            </button>
...
<?php
                            foreach ($results as $val) {
                                $image = '<img src="/uploads/' . $val['image_1'] . '"height="150" width="150">';
                                $id = $val['id'];
                                $title = $val['title'];
...
?>
                        <tr>
                            ...
                            <td><?php echo $sold; ?></td>
                            <td><a href="#" data-toggle="modal" data-target="#editProductModal">Edit</a>
            ...
            <div class="modal-content">
                ...
                <!--    <form role="form" action="/inventories/addInventory" method="post"> -->
                    <form role"form" action="/Uploads/do_upload" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            <input type="submit" class="btn btn-success" value="Edit Item"/>'
                        </div>
                    </form>   
                </div>
